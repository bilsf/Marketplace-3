                        ...
                        <div class="header-slider normal-slider">
                            <div class="header-slider-item">
                                ...
                                <div class="header-slider-caption">
                                    ...
                                    <a class="btn" href="{{ route('user.product-list') }}"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                                </div>
                            </div>
                            <div class="header-slider-item">
                    ...
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            <div class="review-img">
                                <img src="https://awsimages.detik.net.id/community/media/visual/2023/09/22/jokowi-6_169.jpeg?w=600&q=90" alt="Image">
                            </div>
                            <div class="review-text">
                                <h2>Ir.Jokowi</h2>
                                <h3>Presiden dikit lagi</h3>
                                <div class="ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 copyright">
                        <p></a>. All Rights Reserved</p>
                    </div>

                    <div class="col-md-6 template-by">
                        <p>By <a href="#">Robust</a></p>
                    </div>
                </div>
            </div>
        </div>
